  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok || !json.success) {
        alert(json.message || "Failed to update blog");
        setSaving(false);
        return;
      }
      navigate("/blog");
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="submit"
                  form="edit-blog-form"
                  className="inline-flex items-center gap-2 rounded-xl bg-blue-500 px-5 py-2.5 text-sm font-semibold text-white shadow-md hover:bg-blue-400 disabled:opacity-60"
                  disabled={saving}
                >
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-5 md:p-6 space-y-4 shadow-sm dark:border-slate-800 dark:bg-slate-900/70 dark:backdrop-blur">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full rounded-xl border border-gray-300 bg-white px-3 py-2.5 text-sm text-gray-900 outline-none focus:border-blue-500 dark:border-slate-700 dark:bg-slate-950/60 dark:text-slate-100"
